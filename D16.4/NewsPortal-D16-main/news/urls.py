...
from .views import PostsList, PostDetail, SearchPostList, PostCreate, PostUpdate, PostDelete, CategoryListView, subscribe, ArticleCreate, ArticleUpdate, ArticleDelete
